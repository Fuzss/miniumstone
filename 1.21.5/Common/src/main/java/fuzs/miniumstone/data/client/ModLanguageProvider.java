...
public class ModLanguageProvider extends AbstractLanguageProvider {
    ...
    public void addTranslations(TranslationBuilder builder) {
        ...
        builder.add(MiniumStoneTooltipHelper.TooltipComponent.SELECTION.getTranslationKey(), "Selection Mode: %s");
        builder.add(((MiniumStoneItem) ModRegistry.MINIUM_STONE_ITEM.value()).getChangedSelectionTranslationKey(),
                "Changed Selection Mode to %s");
        builder.add(MiniumStoneTooltipHelper.TooltipComponent.CHANGE_SELECTION.getTranslationKey(),
                "Press %s + %s to cycle mode");
        builder.add(MiniumStoneTooltipHelper.TooltipComponent.ADDITIONAL.getTranslationKey(),
                "Hold %s for more information");
        builder.add(MiniumStoneTooltipHelper.TooltipComponent.SHIFT.getTranslationKey(), "Shift");
        ...
        builder.add(MiniumStoneTooltipHelper.TooltipComponent.CHARGE.getTranslationKey(), "Press %s to charge");
        builder.add(MiniumStoneTooltipHelper.TooltipComponent.CRAFTING.getTranslationKey(),
                "Press %s to open crafting grid");
