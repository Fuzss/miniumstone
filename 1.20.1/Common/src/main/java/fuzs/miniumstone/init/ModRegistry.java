...
public class ModRegistry {
    ...
    public static final RegistryReference<RecipeSerializer<TransmutationSmeltingRecipe>> TRANSMUTATION_SMELTING_RECIPE_SERIALIZER = REGISTRY.register(Registries.RECIPE_SERIALIZER, "transmutation_smelting", () -> new SimpleCraftingRecipeSerializer<>(TransmutationSmeltingRecipe::new));
