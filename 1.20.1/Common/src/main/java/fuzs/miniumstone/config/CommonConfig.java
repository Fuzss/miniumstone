...
public class CommonConfig implements ConfigCore {
    @Config(description = {"Monster types that have a rare chance to drop a minium shard for crafting a minium stone.", "Drop chances are similar to wither skeleton skulls from wither skeletons."})
    List<String> miniumShardDropMonstersRaw = ConfigDataSet.toString(Registries.ENTITY_TYPE, EntityType.ZOMBIE, EntityType.ZOMBIE_VILLAGER, EntityType.DROWNED, EntityType.ZOMBIFIED_PIGLIN, EntityType.HUSK, EntityType.SKELETON, EntityType.WITHER_SKELETON, EntityType.STRAY, EntityType.CREEPER, EntityType.SPIDER, EntityType.CAVE_SPIDER, EntityType.ENDERMAN, EntityType.WITCH);
